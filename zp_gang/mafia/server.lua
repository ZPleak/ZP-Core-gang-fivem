...
TriggerEvent('esx_society:registerSociety', 'mafia', 'mafia', 'society_mafia', 'society_mafia', 'society_mafia', 'society_mafia_black', {type = 'public'})

ESX.RegisterServerCallback('mafia:getStockItems', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_mafia', function(inventory)
		cb(inventory.items)
	end)
end)

RegisterNetEvent('mafia:getStockItem')
AddEventHandler('mafia:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('mafia:getPlayerInventory', function(source, cb)
...
RegisterNetEvent('mafia:putStockItems')
AddEventHandler('mafia:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
